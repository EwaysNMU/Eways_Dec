...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <li class="breadcrumb-item active">Deleted Feeds</li>
</ol>
<div class="row">
  <div class="col-12">
    <div class="container-fluid">
            ...
            <table id="example" class="table table-striped table-bordered table-hover table-sm">
                ...
                <tbody>
                 <?php foreach ($feeds_list as $row){?>
                    ...
                    <td ><a href="<?php echo site_url() ?>/admin/rest_feeds/<?php echo $row['feed_id']; ?>"><i class="fa fa-undo fa-2x" aria-hidden="true"></i></a></td>
                </td>
            </tr>
        <?php } ?>
    </tbody>
