...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>/assets/css/back_to_top.css">
...
<!--        <a class="navbar-brand" href="#">E-WAYS</a>-->
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
            ...
            <ul  class="nav navbar-nav">
                ...
                <li class="nav-item">
                    <a id="navhover" href="<?php echo site_url() ?>/community"><i class="fa fa-comments" aria-hidden="true"></i> Learning Community</a>
                </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <li class="nav-item">
